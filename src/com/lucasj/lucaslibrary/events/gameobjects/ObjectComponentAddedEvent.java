...
public class ObjectComponentAddedEvent extends GameEvent {
	
	private GameObject gameObject;
	private Class<? extends ObjectComponent> component;

	public ObjectComponentAddedEvent(GameLib game, GameObject object, Class<? extends ObjectComponent> component) {
		super(game);
